...
/*
 * Recursive methods can be particularly challenging to debug. Adding output statements can be helpful.
 *  Furthermore, an additional trick is to indent the print statements to show the current depth of recursion. 
 *  The following program adds a parameter indent to a findMatch() method that searches a sorted list for an item. 
 *  All of findMatch()'s print statements start with System.out.print(indentAmt + ...);.
 *   Indent is typically some number of spaces. main() sets indent to three spaces. 
 * Each recursive call adds three more spaces. Note how the output now clearly shows the recursion depth.
 */
   ...
   */
   ...
   public static void main(String[] args) {
      ...
      for(int i = 0; i < attendeesList.size(); i++) {
    	           System.out.println(i+". " + attendeesList.get(i));        
       	  }
