...
package chapter_24_Implementing_Lists_Stacks_Queues;

import java.util.*;
import java.util.Iterator;
import java.util.NoSuchElementException;

public class Lavruk_24_03 {
	...
	public Lavruk_24_03() {
		...
		/* end testing MyLinkdList methods */
		
    
		/* Uncomment the following lines to test Exercise 24.3 */
		/*------start of what should work for me ---------*/ 
			java.util.ListIterator<Double> iterator1 = list.listIterator();
			while (iterator1.hasNext())
				System.out.print(iterator1.next() + " ");
		      
			java.util.ListIterator<Double> iterator2 = list.linklistIterator(list.size() - 1);
			System.out.println();
	...
	public class MyLinkedList<E> implements MyList<E> {
		...
		public void addFirst(E e) {
			...
			newNode.previous = null;// <--added code
		...
		Node<E> newNode = new Node<>(e); // Create a new for element e
			...
			if (tail == null) {
				...
				newNode.previous = tail; // <---added code
				newNode.next = null; // <---added code
		...
		public void add(int index, E e) {
			if (index == 0) {
				...
				(current.next).previous = current; // <---added code
		...
		public E remove(int index) {   
			if (index < 0 || index >= size) {
				...
				previous.next.previous = previous; //<---added code (crazy construction)
				size--;
