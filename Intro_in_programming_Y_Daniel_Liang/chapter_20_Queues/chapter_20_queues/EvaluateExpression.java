...
/*
 * page 786
 * This section presents a program that evaluates a
...
operatorStack and applied to the first two operands from operandStack (the two operands 
...
public class EvaluateExpression {
  public static void main(String[] args) {
    ...
    if (args.length != 1) {
      System.out.println(
        "Usage: java Lavruk_20_13 \"expression\"");
      System.exit(1);
    }
