...
public class GenericSort_Listing_19_4 {
...
/**
 * The
method is implemented with a nested for loop. The outer loop 
(with the loop control variable i) 
...
for (int i = 0; i < list.length - 1; i++) { //is iterated in order to find the smallest element in the list, which ranges from
	//list[i] to list[list.length-1], and exchange it with list[i].
currentMin = list[i];
currentMinIndex = i;
