...
public class Lavruk_27_01_teacherFile<K, V> implements MyMap<K, V> {
  ...
  public Lavruk_27_01_teacherFile() {  
    this(DEFAULT_INITIAL_CAPACITY, DEFAULT_MAX_LOAD_FACTOR);    
  }
  
  /** Construct a map with the specified initial capacity and 
   * default load factor */
  public Lavruk_27_01_teacherFile(int initialCapacity) { 
...
public Lavruk_27_01_teacherFile(int initialCapacity, float loadFactorThreshold) { 
