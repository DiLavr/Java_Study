...
public class Lavruk_27_01_test_01<K, V> implements MyMap<K, V> {
	...
	public Lavruk_27_01_test_01() {
		this(DEFAULT_INITIAL_CAPACITY, DEFAULT_MAX_LOAD_FACTOR);
	}

	/** Construct a map with the specified initial capacity and 
	 * default load factor */
	public Lavruk_27_01_test_01(int initialCapacity) {
		this(initialCapacity, DEFAULT_MAX_LOAD_FACTOR);
	}

	/** Construct a map with the specified initial capacity
	 * and load factor */
	public Lavruk_27_01_test_01(int initialCapacity, float loadFactorThreshold) {
